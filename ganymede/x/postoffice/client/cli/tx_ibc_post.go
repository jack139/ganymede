...
func CmdSendIbcPost() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "send-ibc-post [src-port] [src-channel] [title] [content] [sent-date]",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgSendIbcPost(creator, srcPort, srcChannel, timeoutTimestamp, argTitle, argContent, argSentDate)
